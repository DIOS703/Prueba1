...
public class BandejaEntrada extends javax.swing.JFrame {
    ...
    public BandejaEntrada(int idUsuarioLogueado) {
        ...
        jButton1.addActionListener(new MensajeController(this));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        NuevoMensaje nuevomensaje = new NuevoMensaje(this);
        nuevomensaje.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
                MensajeDAO mensaje = new MensajeDAO();
                ArrayList<Mensaje> mensajes = mensaje.getmensajesporID(idUsuarioLogueado);
                DefaultTableModel dtm = (DefaultTableModel) this.getjTable1().getModel();
                dtm.setRowCount(0);
