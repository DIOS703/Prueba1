...
private static BandejaEntrada bdjaentrada;
    /**
     * Creates new form NuevoMensaje
     */
    public NuevoMensaje(BandejaEntrada bdjaentrada) {
        initComponents();
        this.bdjaentrada = bdjaentrada;
        uDAO = new UsuarioDAO();
    ...
    private void enviarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarButtonActionPerformed
        mDAO = new MensajeDAO();
        int idreceptor=0;
        String contenido = cuerpoMensajeTA.getText();
        uDAO = new UsuarioDAO();
        ArrayList<Usuario> usuarios = uDAO.getUsuarios();
        for(int i=0; i<usuarios.size();i++){
            if(usuarios.get(i).getNombre().equals(destinatarioCB.getItemAt(destinatarioCB.getSelectedIndex()))){
                idreceptor = usuarios.get(i).getId_usuario();
        }}
            
        mDAO.insertarmensaje(bdjaentrada.getIdUsuarioLogueado(), idreceptor, contenido);
        //necesito id del emisor y receptor.
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoMensaje(bdjaentrada).setVisible(true);
            }
        });
    }
